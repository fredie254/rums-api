...
function registerAuthRoutes(Router $router, PDO $db): void
{
    ...
    $router->post('auth/login', function () use ($db) {
        ...
        $scopeMap = [
            ...
            'landlord'    => 'read:properties,write:properties,read:units,write:units,read:tenants,write:tenants,read:leases,write:leases,read:payments,write:payments,read:invoices,write:invoices,read:maintenance,write:maintenance,read:reports',
            'owner'       => 'read:properties,write:properties,read:units,write:units,read:tenants,write:tenants,read:leases,write:leases,read:payments,write:payments,read:invoices,write:invoices,read:maintenance,write:maintenance,read:reports',
